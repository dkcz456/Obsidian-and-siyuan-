...
// Import from modularized rsc/ folder
...
// 防抖函数已移动到 rsc/utils/debounce.ts

// =======================================================
// ==                   常量定义                        ==
// =======================================================
// CARD_LIBRARY_VIEW_TYPE 已移动到 rsc/types/constants.ts

// =======================================================
// ==                   接口定义                        ==
// =======================================================

// 卡片数据接口已移动到 rsc/types/interfaces.ts
// CardData, FileCard, NativeCard 接口已移动

// 画布节点接口已移动到 rsc/types/interfaces.ts
// CanvasNode, CanvasData, CanvasEdge 接口已移动

// =======================================================
// ==              布局算法相关接口                     ==
// =======================================================

// 布局算法相关接口已移动到 rsc/types/interfaces.ts
// LayoutConfig, ChildNodePosition, LayoutResult, NodeRelationship, NodeTree 接口已移动

// 筛选状态接口和插件设置接口已移动到 rsc/types/interfaces.ts
// FilterState, PluginSettings 接口已移动
// DEFAULT_SETTINGS 常量已移动到 rsc/types/constants.ts
...
export class CanvasIntegration {
	...
	private async createCanvasNode(cardData: any, event: DragEvent, leaf: any) {
		...
		// 获取鼠标在Canvas中的坐标 - 使用提取的工具函数
		const screenCoords = dragEventToCanvasCoordinates(event, canvasView.canvas.wrapperEl);
